...
Original file is located at
    https://colab.research.google.com/drive/1ATtKnokchmIqjqyem7LgDGuIqpNCDjnI
"""
...
bi_lstm_attention_model = Sequential()
...
# Verifica delle dimensioni dei generatori
print("Dimensioni di train_generator (dati, target):", train_generator[0][0].shape, train_generator[0][1].shape)
print("Dimensioni di test_generator (dati, target):", test_generator[0][0].shape, test_generator[0][1].shape)
print("Dimensioni di test_generator (dati, target):", prediction.shape)

print(df)

print("Dimensioni dei set di addestramento, validazione e test:")
print(f"Dimensioni di X_train: {X_train.shape}")
print(f"Dimensioni di X_train[0]: {X_train.shape[0]}")
print(f"Dimensioni di X_train[1]: {X_train.shape[1]}")
print(f"Dimensioni di y_train: {y_train.shape}")
print(f"Dimensioni di X_val: {X_val.shape}")
print(f"Dimensioni di y_val: {y_val.shape}")
print(f"Dimensioni di X_test: {X_test.shape}")
print(f"Dimensioni di y_test: {y_test.shape}")
print(f"Dimensioni di prediction val: {predictions_val.shape}")
print(f"Dimensioni di prediction test: {predictions_test.shape}")
import numpy as np

# Supponiamo che il tuo dataset sia chiamato 'X' (caratteristiche) e 'y' (target)
print("Shape del dataset di input (caratteristiche):", X.shape)
print("Shape del dataset di output (target):", y.shape)